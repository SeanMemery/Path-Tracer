...
__global__ void SkePUDenoiserNN_Overlap2DKernel_SkePUFDFunc_conv_cuda_2D_kernel(FilterDerivOut* skepu_output, skepu::PRNG::Placeholder,struct FilterDerivIn *skepu_input, int samples, 

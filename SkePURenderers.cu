...
struct skepu_userfunction_skepu_skel_0renderFunc_RenderFunc
{
...
#include "skepu_skel_0_SkePURenderers_MapKernel_RenderFunc.cu"
void Renderers::SkePURender() {

        // Configure SkePU
        auto spec = skepu::BackendSpec{skepu::Backend::typeFromString(skepuBackend)};
        spec.activateBackend();
        skepu::backend::Map<1, skepu_userfunction_skepu_skel_0renderFunc_RenderFunc, decltype(&skepu_skel_0_SkePURenderers_MapKernel_RenderFunc), void> renderFunc(skepu_skel_0_SkePURenderers_MapKernel_RenderFunc);

...
__global__ void skepu_skel_1_SkePURenderers_MapKernel_RenderFunc(ReturnStruct* skepu_output, skepu::PRNG::Placeholder,RandomSeeds *seeds, Constants sConstants,  size_t skepu_w2, size_t skepu_w3, size_t skepu_w4, size_t skepu_n, size_t skepu_base, skepu::StrideList<2> skepu_strides)
{
...
skepu_index.col = (skepu_base + skepu_i) % skepu_w2;
		...
		auto skepu_res = skepu_userfunction_skepu_skel_1renderFunc_RenderFunc::CU(skepu_index, seeds[skepu_i * skepu_strides[1]], sConstants);
